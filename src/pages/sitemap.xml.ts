...
const paths = ['/', '/vivienda/', '/nomina/', '/impuestos/', '/prestamos/', '/ahorro-inversion/', '/ahorro-inversion/interes-compuesto/', '/aviso-legal/', '/privacidad/', '/cookies/', '/fuentes-metodologia/'];
